...
exports.buffer_parse = exports.verify_value = exports.UTC1970Years = void 0;
...
const verify_value = (obj) => Object.entries(obj).map(([key, val]) => console.log(key, typeof val, val));
exports.verify_value = verify_value;
class buffer_parse {
