...
export declare const get_beatmap_file: (hash: string, raw?: boolean, osu_file_beatmap_properties?: osu_file_beatmap_property[], options?: scanner_options) => string | import("..").beatmap_data;
