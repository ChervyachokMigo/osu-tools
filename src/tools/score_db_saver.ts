...
export const scores_db_save = ( scores: scores_db_results, file_path: string ) => {
    ...
    writeFileSync('scores_new.db', buffer.getBuffer(), { encoding: 'binary'});
}